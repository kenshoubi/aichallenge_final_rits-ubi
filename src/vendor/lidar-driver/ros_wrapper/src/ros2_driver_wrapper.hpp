...
private:  //ROS Diagnostics
  LidarDriver::LivoxDiagStatus diag_status_{LidarDriver::LivoxDiagStatus::kErrorNone};
  ...
  std::string LivoxConnectionString(LidarDriver::LivoxDiagStatus diag_status);
