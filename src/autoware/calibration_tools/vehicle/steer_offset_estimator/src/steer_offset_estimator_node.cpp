...
: Node("steer_offset_estimator", node_options)
{
  ...
  update_hz_ = this->declare_parameter("steer_update_hz", 10.0);
  ...
  valid_min_velocity_ = this->declare_parameter("valid_min_velocity", 1.0);
  valid_max_steer_ = this->declare_parameter("valid_max_steer", 0.1);
